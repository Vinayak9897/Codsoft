...
public class Numberguessinggame {
    public static void main(String[]args) {
        ...
        System.out.println("I have a decided a number as a secret number and you have to guess it now.Range is 1 to 100");
      ...
      if (chance == 0){
        ...
        System.out.println("Congratulatons,you guessed the number successfully.");
      }
